...
-**3:熟悉度 :**
因為很多技術都沒什麼經驗，所以在開發的時候大量查詢資料去邊做邊學習，並透過Gemini去了解相關的技術知識
我會把所有的知識都存放到Notion上面做整理，方便之後可以查看學習。
還有每一行的code都自己寫過然後把不懂的問AI，然後Notion記錄下來。

-**4: Docker部屬:**
最後要部屬的時候發現我的Windows版本太舊了!!  
去官網下載更新檔案最後都要我把電腦裡的檔案格式化，最後透過詢問
使用WSL 去啟動 linxu，然後在linxu裡面安裝Docker
